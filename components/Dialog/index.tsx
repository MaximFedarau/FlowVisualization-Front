...
export const Dialog: FC<Props> = ({
  ...
  return (
    <div
      onClick={onClose}
      className="bg-black/50 z-100 h-screen w-screen top-0 fixed flex items-center justify-center"
    >
      <div
        className="flex flex-col bg-white w-[46%] p-12 rounded-lg gap-12"
